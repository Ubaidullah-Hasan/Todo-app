...
const CompletedTasks = ({ task, onDelete }) => {
    return (
        <div className={`bg-[#bfd200]/10 border border-[#55a630] flex items-center justify-between p-4 rounded-lg `}>
            <div>
                <span className="text-[#2b9348] capitalize">{task.text}</span>
            </div>
            <div className='flex items-center md:gap-2'>
                <p className="font-light uppercase border-[#D81158] border text-[#D81158] rounded-md px-1 py-1 text-xs">{task.priority}</p>
